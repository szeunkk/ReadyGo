...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          '체크박스 컴포넌트입니다. status, state, theme 속성을 통해 다양한 상태와 테마를 표현할 수 있습니다.',
      },
    },
  },
  tags: ['autodocs'],
  ...
  render: () => (
    ...
    >
      ...
      >
        ...
        <Checkbox theme="light" status="unselected" state="press" />
        <Checkbox theme="light" status="unselected" state="focus" />
      ...
      >
        ...
        <Checkbox theme="light" status="selected" state="press" />
        <Checkbox theme="light" status="selected" state="focus" />
      ...
      >
        ...
        <Checkbox theme="light" status="partial" state="press" />
        <Checkbox theme="light" status="partial" state="focus" />
  ...
  render: () => (
    ...
    >
      ...
      >
        ...
        <div style={{ fontWeight: 'bold', color: '#ffffff' }}>Default</div>
        <div style={{ fontWeight: 'bold', color: '#ffffff' }}>Hover</div>
        <div style={{ fontWeight: 'bold', color: '#ffffff' }}>Press</div>
        <div style={{ fontWeight: 'bold', color: '#ffffff' }}>Focus</div>
        <div style={{ fontWeight: 'bold', color: '#ffffff' }}>Disabled</div>
        <div style={{ fontWeight: 'bold', color: '#ffffff' }}>Error</div>
      </div>
      <div
        style={{
          display: 'grid',
      ...
      >
        <div style={{ fontWeight: 'bold', color: '#ffffff' }}>Unselected</div>
        <Checkbox theme="dark" status="unselected" state="default" />
        <Checkbox theme="dark" status="unselected" state="hover" />
        <Checkbox theme="dark" status="unselected" state="press" />
        <Checkbox theme="dark" status="unselected" state="focus" />
      ...
      >
        <div style={{ fontWeight: 'bold', color: '#ffffff' }}>Selected</div>
        <Checkbox theme="dark" status="selected" state="default" />
        <Checkbox theme="dark" status="selected" state="hover" />
        <Checkbox theme="dark" status="selected" state="press" />
        <Checkbox theme="dark" status="selected" state="focus" />
      ...
      >
        <div style={{ fontWeight: 'bold', color: '#ffffff' }}>Partial</div>
        <Checkbox theme="dark" status="partial" state="default" />
        <Checkbox theme="dark" status="partial" state="hover" />
        <Checkbox theme="dark" status="partial" state="press" />
        <Checkbox theme="dark" status="partial" state="focus" />
